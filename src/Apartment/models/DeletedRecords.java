...
public class DeletedRecords {
    ...
    public DeletedRecords(int s_No, int register_no, String name, String block, String house_No, String address, String vehicle_details, Date indate, String intime, Date outdate, String outtime, String parking_slot, String reason) {
        S_No = s_No;
